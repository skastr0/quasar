...
`https://<redacted-tailnet-hostname>/`; Tailscale may require admin approval before
...
- dashboard: `http://100.64.0.1:8177`
- Convex client endpoint: `http://100.64.0.1:8178`
- Convex HTTP actions endpoint: `http://100.64.0.1:8179`
