...
const goldenQueries = [
  ...
  },
  {
    id: "work-item",
    category: "readiness / index health",
    query: "work-item search readiness",
    expectedAny: ["work-item", "search readiness", "readiness"],
  },
  {
  ...
  },
  {
    id: "work-item",
    category: "recent workflow / proof threads",
    query: "work-item incremental local-server sync",
    expectedAny: ["work-item", "incremental", "local-server", "sync"],
  },
  {
    id: "retrieval-proof",
    category: "recent workflow / proof threads",
