...
const DEFAULT_SERVER = process.env.QUASAR_LOCAL_SERVER_URL ?? "http://100.64.0.1:6180";
...
Examples:
  bun scripts/compare-local-search.mjs --server http://100.64.0.1:6180 --name gemini
  bun scripts/compare-local-search.mjs --profile gemini=http://100.64.0.1:6180 --profile nomic=http://100.64.0.1:6181
`);
};
