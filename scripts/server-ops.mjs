...
const usage = {
  commands: {
    ...
    "materialize-staging": "run non-live materialization proof in a one-off Docker container with the data volume mounted read-only",
  ...
  examples: [
    ...
    "bun scripts/server-ops.mjs materialize-staging --out docs/proofs/materialize-staging-docker.json",
