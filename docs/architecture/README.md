...
- **[Quasar — Data-Reality Plan](quasar-data-reality-plan-2026-06-11.md)** — the
  ...
  embeddings), and the build sequence the current work sequence.
...
The sync-contract era artifacts were deleted on 2026-06-11 at work-item:
...
from git history at the commit preceding the work-item reorientation. Their one durable
