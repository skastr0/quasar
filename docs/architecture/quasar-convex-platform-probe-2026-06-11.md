...
This report records the work-item platform probe. It intentionally excludes the
...
- The at-rest multiplier probe hit a Convex write-rate rejection before reaching
  ...
  deployment.` Per AGENTS.md, this halts work-item until there is a written shape
