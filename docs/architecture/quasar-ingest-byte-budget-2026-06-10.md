...
Baseline validation on the post-work-item tree:
...
| --- | --- | --- | --- | --- |
| codex | codex-local-jsonl | available | `/home/user/.codex/sessions` | Discovered 524 Codex source units; processed 524; skipped 0. |
| claude | claude-code-project-jsonl | available | `/home/user/.claude/projects` | Discovered 67 Claude sessions. |
| opencode | opencode-sqlite | available | `/home/user/.local/share/opencode/opencode-local.db` | Discovered 881 OpenCode sessions. |
| grok | grok-session-folder | available | `/home/user/.grok/sessions` | Discovered 10 Grok sessions. |
| hermes | hermes-state-sqlite | available | `/home/user/.hermes/state.db` | Discovered 74 Hermes sessions. |
| amp | amp-local-threads | no_data_found | `/home/user/.local/share/amp` | Discovered 0 Amp sessions; skipped `secrets.json`. |
| pi | pi-local-json-tree | no_data_found | `/home/user/.pi/agent/sessions` | Pi root was not found. |
| kimi | kimi-local-wire | no_data_found | `/home/user/.kimi-code` | Discovered 0 Kimi sessions. |
| droid | factory-droid-local-captures | no_data_found | `/home/user/.factory` | Discovered 0 Factory/Droid captures. |
| antigravity | antigravity-local-transcripts | no_data_found | `/home/user/.gemini/antigravity` | Antigravity root was not found. |
| cursor | cursor-sqlite-copied | no_data_found | `/home/user/Library/Application Support/Cursor/User` | Cursor User storage root was not found. |
...
Create and complete a Forge follow-up before work-item:
...
### work-item Corrected Baseline

After preserving structured and metadata-bearing content blocks, the corrected
post-work-item full-machine dry-run still failed the gate.
...
### work-item Latest-Tree Rerun

work-item made the canonical projection leaner:
...
Field-level measurement after work-item showed the remaining bulk is no longer
...
Verdict: work-item materially improved the corrected baseline, but the byte gate
...
work-item compacted derivable child identity and per-event source evidence:
...
Field-level attribution after work-item:
...
Verdict: work-item materially improved work-item, but the byte gate still fails.
...
detail belongs in live server storage before work-item: content block sidecars,
