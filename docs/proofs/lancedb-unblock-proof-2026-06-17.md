...
- Search data dir: `/home/user/.config/quasar/search.lance`
...
```text
state = running
QUASAR_SEARCH_DATA_DIR => /home/user/.config/quasar/search.lance
runs = 2
pid = 10006
```
...
- LanceDB: `19G /home/user/.config/quasar/search.lance`
- Old Convex search storage: `0B /home/user/.config/quasar/local/default/convex_local_storage/search`
