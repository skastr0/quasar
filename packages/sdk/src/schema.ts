 ...
 * server (producer, bun:sqlite native), CLI/TUI/the other product (consumers, HTTP clients). */
...
// https://<redacted-tailnet-hostname> (LIVE check 1): ProjectRow.rawPath came
