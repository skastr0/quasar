...
const SessionItem = Schema.Struct({
  ...
  model: Schema.optional(Model),
  modelProvider: Schema.optional(ModelProvider),
  messageCount: Schema.optional(NonNegativeInteger),
  toolCallCount: Schema.optional(NonNegativeInteger),
  parentSessionId: Schema.optional(SessionId),
  agentRole: Schema.optional(AgentRole),
  agentPath: Schema.optional(boundedString("QuasarAgentPath", 2_048)),
  agentDepth: Schema.optional(NonNegativeInteger),
});
...
const ToolCallItem = Schema.Struct({
  ...
  inputBytes: Schema.optional(NonNegativeInteger),
  outputBytes: Schema.optional(NonNegativeInteger),
  agentName: Schema.optional(AgentName),
  agentRole: Schema.optional(AgentRole),
  model: Schema.optional(Model),
  modelProvider: Schema.optional(ModelProvider),
