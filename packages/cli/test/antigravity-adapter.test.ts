...
// ---------------------------------------------------------------------------
// work-item: first-class subagents.
//
...
// ---------------------------------------------------------------------------
describe("work-item: cross-session subagent lineage", () => {
...
// ---------------------------------------------------------------------------
// work-item: a non-list manage_subagents op is real (kept), and a malformed
// transcript line becomes a NAMED decode diagnostic + a dropped record.
// ---------------------------------------------------------------------------
describe("work-item: subagent_admin op kept + fail-closed decode", () => {
