...
// ---------------------------------------------------------------------------
// work-item — first-class subagents: session-to-session lineage.
//
...
// ---------------------------------------------------------------------------
describe("work-item opencode subagent lineage", () => {
...
describe("opencode adapter", () => {
  test(
    ...
    async () => {
      ...
      // work-item: the assistant's reasoning part surfaces as a SEPARATE
      ...
      // work-item / F-1: mixed session (product turns + pruned summary.diffs)
  ...
  // work-item / F-1: garbage-only session — oversized summary.diffs machinery,
...
// ---------------------------------------------------------------------------
describe("work-item full data fidelity: declarative per-record-type dispatch", () => {
