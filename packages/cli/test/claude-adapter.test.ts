...
// ===========================================================================
// work-item FULL DATA FIDELITY — declarative per-record-type signal/drop dispatch.
//
...
// ---------------------------------------------------------------------------
// work-item / signal: conversation records map to the correct conversation kind.
// ---------------------------------------------------------------------------
describe("work-item signal: user/assistant conversation kinds", () => {
...
// ---------------------------------------------------------------------------
// work-item / system subtypes: explicit signal(kind) or drop(reason).
// ---------------------------------------------------------------------------
describe("work-item system subtype dispatch", () => {
  ...
  // work-item FIX (finding 3): on real disk `error` is ALWAYS an object
...
// ---------------------------------------------------------------------------
// work-item / attachment subtypes: every modeled subtype is signal or drop.
// ---------------------------------------------------------------------------
describe("work-item attachment subtype dispatch", () => {
  ...
  // work-item FIX (finding 2): a satisfied goal_status carries a UNIQUE
...
describe("work-item top-level type dispatch", () => {
  ...
  // work-item FIX (finding 1): queue-operation is POLYMORPHIC by `operation`. An
...
// ---------------------------------------------------------------------------
// work-item / malformed records: NAMED diagnostic + drop, never a throw.
// ---------------------------------------------------------------------------
describe("work-item malformed records -> named diagnostic + drop (no throw)", () => {
...
// ---------------------------------------------------------------------------
// work-item / end-to-end: drops never become events; signals do; lineage intact.
// ---------------------------------------------------------------------------
describe("work-item end-to-end through the adapter", () => {
...
// ---------------------------------------------------------------------------
// work-item FIX (finding 4): a kept turn whose parentUuid points DIRECTLY at a
...
// ---------------------------------------------------------------------------
describe("work-item lineage: parent points at a DROPPED record -> nearest kept ancestor", () => {
...
// ---------------------------------------------------------------------------
// work-item FIX (finding 5): a subagent/workflow-agent file is a first-class child
...
describe("work-item subagent_of session lineage", () => {
