...
/**
 * A part row after declarative per-record-type dispatch . The raw
...
// Session lineage columns . `parent_id` carries the subagent's own
...
const buildOpenCodeSessionFromRows = (
  ...
  // Session-to-session subagent lineage : a non-null `session.parent_id`
