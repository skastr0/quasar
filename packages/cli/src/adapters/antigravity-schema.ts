...
// ---------------------------------------------------------------------------
// Antigravity on-disk record schema (work-item fail-closed boundary)
//
 ...
 * 2026-06-21). This is the FULL DATA FIDELITY inventory : every record
...
// ---------------------------------------------------------------------------
// Declarative per-record-type signal/drop dispatch (work-item FULL DATA FIDELITY)
//
